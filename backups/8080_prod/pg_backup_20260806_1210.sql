...
\restrict mMHH22Sxpk8agvjgG4BOAUC7SGk2xXzBOZ2f4HCi14xhzeao0HpBjO5U7zsZb2R
...
CREATE TABLE public.inventory_components (
    ...
    model text,
    srno text,
    type character varying(50) DEFAULT 'Component'::character varying,
    category text,
...
CREATE TABLE public.inventory_items (
    ...
    itemname text NOT NULL,
    itemdescription text,
    status character varying(50) DEFAULT 'In Store'::character varying,
    make text,
    model text,
    srno text,
    serialno text,
    ...
    icon text,
    parentid character varying(255),
    folderid character varying(255) DEFAULT 'IF-INBOX'::character varying NOT NULL,
    kindid character varying(255) DEFAULT 'IK-MISC'::character varying NOT NULL,
    currentlocation text,
    remarks text,
    lastupdated timestamp with time zone DEFAULT now(),
    ...
    amc_months integer,
    quantity_total double precision DEFAULT 0,
    ...
    is_deleted integer DEFAULT 0,
    deleted_at timestamp with time zone,
    dispatchreceivedt timestamp with time zone,
    purchasedetails text,
    purpose text,
    purchasedate date,
    ...
    conversion_mode character varying(20),
    macaddress text,
    ipaddress text,
    networktype text,
    physicalport text,
...
CREATE TABLE public.inventory_quantity_event_lines (
    ...
    delta_available double precision DEFAULT 0,
    delta_total double precision DEFAULT 0
);
...
COPY public.inventory_folders (id, name, parentid, icon, module, createdby, createdat, lastupdated, is_deleted, deleted_at) FROM stdin;
IF-INBOX	Inbox	\N	📥	INVENTORY	system	2026-08-06 12:03:53.816362+00	2026-08-06 12:03:53.816362+00	0	\N
\.
...
IK-MISC	Misc	IF-INBOX	\N	INVENTORY	🏷️	\N	\N	2026-08-06 12:03:53.818442+00	0	\N
\.
...
SELECT pg_catalog.setval('public.inventory_quantity_events_id_seq', 1, false);
...
\unrestrict mMHH22Sxpk8agvjgG4BOAUC7SGk2xXzBOZ2f4HCi14xhzeao0HpBjO5U7zsZb2R
