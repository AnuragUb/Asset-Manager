console.log('MAIN.JS: Entry point (v6.03)');
import { showView } from './utils.js?v=6.02';
import { renderDashboard, setupDashboard, setupDashboardFormHandlers, renderSidebarTree, editAsset } from './dashboard.js?v=6.02';
// import { initScannerView } from './networkScanner.js?v=5.50';
import { renderItAssets } from './itAssets.js?v=6.02';
import { setupAuth, checkSession } from './auth.js?v=6.02';
import { HierarchyManager } from './hierarchy.js?v=6.02';
import { initEmployeeView, loadEmployees } from './employees.js?v=6.02';
// import { setupOcr } from './ocr.js?v=5.50';
import { initWarrantyView } from './warranty.js?v=6.02';
import { initProjectsView } from './projects.js?v=6.02';
import { initSettingsView } from './settings.js?v=6.02';
