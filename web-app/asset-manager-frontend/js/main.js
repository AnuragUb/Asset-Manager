console.log('MAIN.JS: Entry point (v6.54)');
import { showView } from './utils.js?v=6.54';
import { renderDashboard, setupDashboard, setupDashboardFormHandlers, renderSidebarTree, editAsset } from './dashboard.js?v=6.54';
// import { initScannerView } from './networkScanner.js?v=5.50';
import { renderItAssets } from './itAssets.js?v=6.54';
import { setupAuth, checkSession } from './auth.js?v=6.54';
import { HierarchyManager } from './hierarchy.js?v=6.54';
import { initEmployeeView, loadEmployees } from './employees.js?v=6.54';
// import { setupOcr } from './ocr.js?v=5.50';
import { initWarrantyView } from './warranty.js?v=6.54';
import { initProjectsView } from './projects.js?v=6.54';
import { initSettingsView } from './settings.js?v=6.54';
import { initCompanyTemplates } from './companyTemplates.js?v=6.54';
import { initDCProjectFetcher, initDCAliasLogic } from './dcProjectFetcher.js?v=6.54';
import { initLoginAnimations, initLoginModuleSelector, initSignupModal } from './loginAnimations.js?v=6.54';
import { initFormAutosave } from './formAutosave.js?v=6.54';
import { initContextMenu } from './contextMenu.js?v=6.54';
