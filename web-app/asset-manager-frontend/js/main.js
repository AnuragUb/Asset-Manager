console.log('MAIN.JS: Entry point (v6.83)');
import { showView } from './utils.js?v=6.60';
import { renderDashboard, setupDashboard, setupDashboardFormHandlers, renderSidebarTree, editAsset } from './dashboard.js?v=6.83';
...
import { initInventoryView } from './inventory.js?v=6.83';
...
import { initContextMenu } from './contextMenu.js?v=6.83';
