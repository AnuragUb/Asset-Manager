...
\restrict Jm3K3bfIByI2MZvpmLWK0DKkQj8TCsqFK4386TxVlpYZ3Jfm35mLDwgqm5dGf1l
...
ALTER TABLE public.delivery_challans OWNER T: dc_item_mappings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
CREATE TABLE public.users (
    usernaemplates ALTER COLUMN id SET DEFAULT nextval('public.company_templates_id_seq'::regclass);
...
\unrestrict Jm3K3bfIByI2MZvpmLWK0DKkQj8TCsqFK4386TxVlpYZ3Jfm35mLDwgqm5dGf1l
...
\unrestrict fq8Qh2KtNooeG46N4V65XbdEL29UggdZctrMMZFcsRL7TBRyUyqS6BYLJzmIyLm
